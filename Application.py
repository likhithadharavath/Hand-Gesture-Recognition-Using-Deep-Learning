...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text = "Hand Gesture Recognition", font = ("times", 20, "bold"))
        ...
        self.T1.config(text = "Captured Character :", font = ("times", 20, "bold"))
        ...
        self.T2.config(text = "Captured Word :", font = ("times", 20, "bold"))
        ...
        self.T3.config(text = "Sentence :",font = ("times", 20, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x = 740, y = 60)
        self.T4.config(text = "Suggestions :", fg = "red", font = ("times", 20, "bold"))

        self.bt1 = tk.Button(self.root, command = self.action1, height = 0, width = 0)
        self.bt1.place(x = 820, y = 140)

        self.bt2 = tk.Button(self.root, command = self.action2, height = 0, width = 0)
        self.bt2.place(x =900, y = 140)

        self.bt3 = tk.Button(self.root, command = self.action3, height = 0, width = 0)
        self.bt3.place(x = 990, y = 140)
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            self.panel3.config(text = self.current_symbol, font = ("times", 30))

            self.panel4.config(text = self.word, font = ("times", 30))

            self.panel5.config(text = self.str,font = ("times", 30))
